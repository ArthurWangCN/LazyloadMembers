...
export default {
  ...
  data() {
    ...
    {
        "id": "7838db29-e687-4037-b567-e7ade92c6370",
        "name": "集成电路设计12345",
        "orgId": "7838db29-e687-4037-b567-e7ade92c6370",
        "sort": 0,
        "grade": 0,
        "hasChild": null,
        "checked": false,
  ...
  methods: {
    ...
    loadNode(node, resolve) {
      ...
      if (node.level > 0) {
        this.deptArr.push(node.data.id);
    ...
    loadMore(event) {
      ...
      // if (ele.scrollTop > this.scrollTop) {
        ...
        if (
          ...
          (document.querySelector("#memberList").clientHeight)
        ) {
